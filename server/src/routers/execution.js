...
exports.executionRouter = (0, trpc_1.router)({
    ...
    execute: trpc_1.publicProcedure
        ...
        return __generator(this, function (_c) {
            ...
            return [2 /*return*/, { result: 'success', executionId: 'exec_123' }];
        });
    }); }),
    // Placeholder for executeStream
    executeStream: trpc_1.publicProcedure
        .input(zod_1.z.object({
        flowId: zod_1.z.string(),
        configId: zod_1.z.string(),
        context: zod_1.z.any().optional(),
        ...
        return (0, observable_1.observable)(function (emit) {
            ...
            var interval = setInterval(function () {
                emit.next("Executing step for ".concat(input.flowId, "..."));
            }, 1000);
            // Cleanup
            return function () {
